...
export default function Gallery({ onLightboxToggle }) {
  ...
  useEffect(() => {
    onLightboxToggle?.(open)
  }, [open, onLightboxToggle])
  ...
  return (
    ...
    >
      ...
      {open && createPortal(
        <div className="fixed inset-0 z-[9999] flex flex-col bg-black/90" onClick={() => setIdx(null)}>
          {/* top bar */}
          ...
          <div className="relative z-[10000] flex flex-1 items-center justify-center px-12 md:px-20 min-h-0">
